...
namespace twixt
{
	...
	public:
		...
		std::vector<nonstd::observer_ptr<Bridge>> getConnections() const;
		...
		void setConnections(const std::vector<nonstd::observer_ptr<Bridge>>&);
		...
		virtual bool addBridge(nonstd::observer_ptr<Bridge>, const Position&) = 0;
		virtual void removeBridge(nonstd::observer_ptr<Bridge>) = 0;
	};
}
